...
CMDs[#CMDs + 1] = {NAME = 'oldugc', DESC = 'Free ugc script'}
CMDs[#CMDs + 1] = {NAME = 'hideall', DESC = 'Hide all players'}
CMDs[#CMDs + 1] = {NAME = 'ugc', DESC = 'Free ugc script v2'}
